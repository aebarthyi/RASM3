all: RASM3Driver.o String_equals.o String_Length.o String_indexOf_1.o barnett_12Feb20.a
	ld -o RASM3Driver RASM3Driver.o String_equals.o String_Length.o String_indexOf_1.o barnett_12Feb20.a
