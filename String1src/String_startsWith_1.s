...
String_startsWith_1:
	...
	mov	r6, r2		@preserving the begin index to call String_length
...
loop:
	...
	ldrb	r3, [r5, r6]	@extracting the character from string in to r3

	add	r1, #1		@incrementing the string index counter
	add	r6, #1		@incrementing the substring index counter
